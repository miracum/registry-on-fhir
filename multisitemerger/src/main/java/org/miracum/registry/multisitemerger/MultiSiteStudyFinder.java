...
public class MultiSiteStudyFinder {
    ...
    /**
     * Given a flat list of ResearchStudy resources, this method returns a list of
     * lists where each list represents a cluster of ResearchStudy resources describing
     * the same master study. Affinity to a master study is determined by the
     * ResearchStudy's identifiers.
     *
     * @param studies the list of ResearchStudy resource from which to construct the
     *                master study sets.
     * @return a list of lists where each list represents a set of ResearchStudy resources
     *         belonging to the same master study.
     */
    public List<Set<ResearchStudy>> findMultiSiteStudies(List<ResearchStudy> studies) {
        ...
        for (var study : studies) {
            ...
            for (var identifier : study.getIdentifier()) {
                var identifierString = String.format("%s|%s",
