...
@RestController
@RequestMapping(value = "/updates", produces = {"application/json", "application/fhir+json"})
public class MergeUpdateController {
    ...
    public MergeUpdateController(FhirServerStudySource source,
    ...
    private MethodOutcome createSubscription() {
        ...
        log.info("Creating subscription resource with criteria '{}' and endpoint '{}'", criteria, hookEndpoint);
    ...
    private ResponseEntity<String> mergeAllServerStudies() {
        return mergeDurationTimer.record(() -> {
            ...
            var masterStudies = multiSiteStudies
                    .stream()
    ...
    @RequestMapping(value = "/ResearchStudy/{id}",
            consumes = "application/fhir+json",
            method = {RequestMethod.POST, RequestMethod.PUT})
    public ResponseEntity<String> updates(@PathVariable(value = "id") String resourceId,
        ...
        // TODO: do something with the updated study, ie. check if it needs to be merged into a master record.
